...
type MetricData struct {
	...
	Endpoint      string                 `protobuf:"bytes,15,opt,name=endpoint,proto3" json:"endpoint,omitempty"`
...
func (x *MetricData) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
const file_metrics_proto_rawDesc = "" +
	"\n" +
	"\rmetrics.proto\x12\x14digestlogger.metrics\"\x89\x06\n" +
	"\n" +
	"MetricData\x12\x1b\n" +
	...
	"\bendpoint\x18\x0f \x01(\tR\bendpoint\x1a=\n" +
